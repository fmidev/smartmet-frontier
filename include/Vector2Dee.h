...
namespace frontier
{
  ...
  public:
	...
	static DoubleArr getScaledNormal(DoubleArr leftPosition, DoubleArr basePosition, DoubleArr rightPosition,  boolean isLeftOriented, double scaler);
	static DoubleArr getUnitNormal(DoubleArr leftPosition, DoubleArr basePosition, DoubleArr rightPosition, boolean isLeftOriented);
	static DoubleArr getUnitNormal(DoubleArr normalizedVector1, DoubleArr normalizedVector2, boolean isLeftOriented);
