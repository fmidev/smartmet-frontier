...
PreProcessor::PreProcessor(const std::string & theDefineDirective,
  ...
  : NFmiPreProcessor(stripPound,stripDoubleSlash,stripSlashAst,stripSlashAstNested,stripEndOfLineSpaces)
...
const std::string PreProcessor::getDefinedValue(const std::string & theDefine,const std::string & theDefaultValue) const
{
