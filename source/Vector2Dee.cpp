...
DoubleArr Vector2Dee::getScaledNormal(DoubleArr leftPosition, DoubleArr basePosition, DoubleArr rightPosition,  boolean isLeftOriented, double scaler)
{
...
DoubleArr Vector2Dee::getUnitNormal(DoubleArr leftPosition, DoubleArr basePosition, DoubleArr rightPosition, boolean isLeftOriented)
{
...
DoubleArr Vector2Dee::getUnitNormal(DoubleArr normalizedVector1, DoubleArr normalizedVector2, boolean isLeftOriented)
{
	//////////////////////////////////////////////////////////////////////////
	...
	if(normalizedVector1 == getNegatedVector(normalizedVector2))
	{
		...
		// Set up a (rather clumsy) epsilon displacement just to make vectors point slightly different directions
		normalizedVector1[0] += 0.00001; // Only displace X of 'vector1'
		normalizedVector2[1] += 0.00001; // Only displace Y of 'vector2'
	}

	DoubleArr normal = getUnitVector(Vector2Dee::getAddedVector(normalizedVector1, normalizedVector2));
...
DoubleArr Vector2Dee::getRotatedUnitVector(DoubleArr p1, DoubleArr p2, double rotationAngleInDegrees)
{
